...
INSERT INTO TRADES
(book_id, security_id, counterparty_id, currency, status, quantity, unit_price, bond_holder, trade_type, trade_date, trade_settlement_date)
SELECT id, id, id, currency, status, quantity, unit_price, bond_holder, trade_type, trade_date, trade_settlement_date
FROM CSVREAD('C:/work/Group20Project/java-api/src/main/resources/db-bonds-data.csv');
